...
Time : 30/07/2023 12:43 PM
Desc: aws_s3_service.py
"""
...
class AWSS3StorageServiceSP(BooksStorageServiceSPI):
    ...
    def upload_file(self, file_name: str, container_name: str):
        try:
            print("AWS S3 bucket file uploading logic handling code goes here")
        except Exception as e:
            raise FileUploadExeption(message="Error occurred while uploading a file. {}".format(str(e)))

    def download_file(self, file_name: str):
        try:
            print("AWS S3 bucket file downloading logic handling code goes here")
        except Exception as e:
